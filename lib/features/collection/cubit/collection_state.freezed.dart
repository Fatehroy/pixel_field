...
mixin _$CollectionState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<CarModel> cars) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<CarModel> cars)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<CarModel> cars) : _cars = cars;
  ...
  @override
  String toString() {
    return 'CollectionState.loaded(cars: $cars)';
  }
...
abstract class _Loaded implements CollectionState {
  const factory _Loaded(final List<CarModel> cars) = _$LoadedImpl;
